...
const rolePermissions = {
  ...
  engineer: ['/', '/staff-mobile-workspace', '/staff-workorder-list', '/staff-workorder-detail', '/staff-workorder-create', '/staff-field-checkin-list', '/staff-checkin', '/staff-profile', '/staff-profile-desktop', '/field-service', '/parts', '/qrcode', '/scan'],
